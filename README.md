...
- Tax envelope endpoints:
  ...
  - `GET /api/admin/tax-envelope/payment-summary`
- Giving envelope endpoints:
  - `GET /api/admin/giving-envelope`
  - `POST /api/admin/giving-envelope/deposit`
  - `POST /api/admin/giving-envelope/withdraw`
